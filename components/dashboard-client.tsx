        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-2xl font-bold text-gray-900">TaxGrok.AI</h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {/* Tax Forms Data Management Card */}
            <Card className="border-2 border-dashed border-gray-200 hover:border-green-300 transition-colors">
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  <FileText className="h-5 w-5 text-green-500" />
                  <span>Import Tax Form Data</span>
                </CardTitle>
                <CardDescription>
                  Upload CSV, Excel, or JSON files with tax form data (W-2s, 1099s) and map them to tax forms
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-4">
                  <p className="text-sm text-gray-600 mb-4">
                    Upload structured data files and map fields to tax forms
                  </p>
                  <Button 
                    onClick={() => router.push(`/tax-forms${currentTaxReturn ? `?taxReturnId=${currentTaxReturn.id}` : ''}`)}
                    className="w-full"
                    variant="outline"
                  >
